...
joined as (
    ...
    select
        ...
        aggregate_leaderboards.leaderboard_competition,
...
new_rank as (
    ...
    select
        *,
        dense_rank() over (partition by region, leaderboard_competition, period_type, period_start order by total_points desc) as leaderboard_rank
    from joined
)
