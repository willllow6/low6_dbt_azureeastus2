...
joined as (
    ...
    select
        ...
        ranked_entries.client_id,
        ranked_entries.tenant_id,
        ranked_entries.game_type,
        ...
        entry_selections.nba_picks,
        entry_selections.nfl_picks,
        entry_selections.nhl_picks,
