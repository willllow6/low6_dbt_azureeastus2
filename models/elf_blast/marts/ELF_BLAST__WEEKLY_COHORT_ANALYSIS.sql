...
select 
    first_entry_week,
    entry_week,
    sum(first_entry_week_active_users) as first_entry_week_active_users,
    sum(active_users) as active_users,
    sum(active_users) / sum(first_entry_week_active_users) as retention_rate
from add_first_entry_week_active_users
group by 1,2
