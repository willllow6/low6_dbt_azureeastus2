...
d1_retention as (
    ...
    from entries
        left join entries as future_entries
            ...
            and entries.entry_date_et = future_entries.entry_date_et - interval '1 day'
    where entries.user_entry_number = 1
    and entries.entry_date_et < current_date - interval '1 day'
...
d7_retention as (
    ...
    from entries
        left join entries as future_entries
            on entries.user_id = future_entries.user_id
            and entries.entry_date_et = future_entries.entry_date_et - interval '7 day'
    where entries.user_entry_number = 1
    and entries.entry_date_et < current_date - interval '7 day'
...
d14_retention as (
    ...
    from entries
        left join entries as future_entries
            on entries.user_id = future_entries.user_id
            and entries.entry_date_et = future_entries.entry_date_et - interval '14 day'
    where entries.user_entry_number = 1
    and entries.entry_date_et < current_date - interval '14 day'
...
d28_retention as (
    ...
    from entries
        left join entries as future_entries
            on entries.user_id = future_entries.user_id
            and entries.entry_date_et = future_entries.entry_date_et - interval '28 day'
    where entries.user_entry_number = 1
    and entries.entry_date_et < current_date - interval '28 day'
...
maus as (
    ...
    from entries
    where 
        entry_date_et < current_date
        and entry_date_et >= current_date - 29
)
